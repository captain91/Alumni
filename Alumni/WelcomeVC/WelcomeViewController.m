...
{
    if (self = [super init]) {
        self.introductionView = [[WelcomeView alloc ] initWithCoverImageNames:coverNames backgroundImageNames:bgNames button:button];
    }
    return self;
}
...
{
    if (self = [super init]) {
        self.introductionView = [[WelcomeView alloc ] initWithVideo:videoURL volume:volume];
    }
    return self;
}
